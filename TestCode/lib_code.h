...
enum class ProcUserType
{
    Default,
    System,
    System_Trusted_Installer,
    Current_User,
    Current_User_Admin,
    Current_Proc,
    Current_Proc_Drop_Right,
};

enum class NSUDO_PRIVILEGES_MODE_TYPE
{
    DEFAULT,
...
#pragma region Definitions for Windows (Win32 Style)
    ...
    */
     ...
     *         containing the error code.
    */
    ApiResult GetNtfsCompressionAttribute(
     ...
     *         containing the error code.
    */
    ApiResult SetNtfsCompressionAttribute(
        _In_ HANDLE FileHandle,
    ...
    */
     ...
     *         containing the error code.
    */
    ApiResult GetFileAllocationSize(
        _In_ HANDLE FileHandle,
     ...
     *         containing the error code.
    */
    ApiResult GetCompressedFileSizeByHandle(
        _In_ HANDLE FileHandle,
     ...
     *         containing the error code.
    */
    ApiResult GetFileAttributesByHandle(
        _In_ HANDLE FileHandle,
     ...
     *         containing the error code.
    */
    ApiResult SetFileAttributesByHandle(
        _In_ HANDLE FileHandle,
     ...
     *         containing the error code.
    */
    Mile::ApiResult GetFileHardlinkCountByHandle(
        _In_ HANDLE FileHandle,
    ...
    */
    ApiResult create_token_for_current_user(
    ...
    */
     ...
     *         containing the error code.
    */
    ApiResult create_token_for_pid(
     ...
     * @return An HResult object containing the error code.
    */
    HResult create_token_for_service(
        _In_ LPCWSTR ServiceName,
        _In_ DWORD DesiredAccess,
        _Out_ PHANDLE TokenHandle);
     ...
     * @return An HResult object containing the error code.
    */
    HResult modify_token_privileges(
        _In_ HANDLE TokenHandle,
     ...
     * @return An HResult object containing the error code.
    */
    HResult set_token_all_privilege(
        _In_ HANDLE TokenHandle,
